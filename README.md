...
**事务（隔离性）**（`bitcask_txn`，6.5.1）— 在原子批之上补齐隔离：悲观 2PL +
...
| `ROADMAP.md` / `ROADMAP_EN.md` | **路线图**：6.6.0 / 6.5.1 / 6.5.0 / 6.4.0 / 6.3.2 / 6.3.1 / 6.2.2 / 6.2.1 / 6.1.0 / 6.0.0 / 5.1.0 / 5.0.0 / 4.0.0 / 3.1.0 / 3.0.0 落地 + 2.1.1 已落地（P5–P15）+ 2.2.0 规划（libcask 独立 / V7+ 向量优化）（中/英） |
| `TASK.md` | 详细任务拆分与历史 |
